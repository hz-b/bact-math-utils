...
import unittest
from bact_math_utils import life_time, exp_fit
import numpy as np
import copy

lifetime_function = life_time.lifetime_function
lifetime_function_orig = life_time.lifetime_function_orig
...
estimate_tau_inv = exp_fit.estimate_tau_inv
fit_scaled_exp = exp_fit.fit_scaled_exp
